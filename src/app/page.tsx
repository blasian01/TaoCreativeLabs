...
const services = [
    {
        title: "Consumer AI SaaS",
        description:
            "We build, launch, and scale consumer-facing AI applications — from creative storytelling platforms to personal AI utility apps.",
        icon: (
    ...
    },
    {
        ...
        description:
            "Enterprise-grade software solutions powering marketing, content creation, and intelligent workflow automation for modern businesses.",
        icon: (
            <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor">
    ...
    {
        title: "Product AI Consulting",
        description:
            "Applying our experience from scaling consumer applications to help ambitious businesses design, build, and deploy reliable AI solutions.",
        icon: (
            <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor">
        ...
        <>
                    ...
                    <div className="liquid-glass rounded-3xl px-10 py-16 md:px-16 md:py-20">
                        <FadeIn>
                            <p className="font-grotesk text-[11px] font-medium uppercase tracking-[0.35em] text-brand-violet/70">
                                A House of Innovative AI Software
                            </p>
                        </FadeIn>
                        ...
                        <FadeIn delay={0.3}>
                            <p className="mt-6 text-lg font-light leading-relaxed text-black/80 md:text-xl">
                                We Build and Scale Premium AI SaaS Products.
                            </p>
                        </FadeIn>

                        <FadeIn delay={0.4}>
                            <p className="mt-3 text-[15px] font-light text-black/50">
                                An incubator and venture studio defining the future of consumer and B2B artificial intelligence applications.
                            </p>
                        </FadeIn>

                        <FadeIn delay={0.55}>
                            <div className="mt-12 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
                                <Button href="/products">View Our SaaS Portfolio</Button>
                ...
                <div className="mx-auto max-w-7xl relative">
                    ...
                    <FadeIn delay={0.3}>
                        <div className="mt-16 flex justify-center">
                            <Button href="/products" variant="secondary">View Complete Details</Button>
                        </div>
                    </FadeIn>
                </div>
            </section>
                ...
                <div className="mx-auto max-w-7xl">
                    <FadeIn>
                        <SectionHeading
                            ...
                            subtitle="Three pillars of our venture studio — from consumer products to enterprise infrastructure."
                        />
                    </FadeIn>
            ...
            <section id="about" className="relative z-[1] section-bg py-32 px-6 lg:px-12">
                ...
                <div className="mx-auto max-w-3xl text-center relative">
                    <FadeIn>
                        <SectionHeading title="About Tao Creative Labs" />
                    </FadeIn>
                    <FadeIn delay={0.15}>
                        <p className="text-[16px] font-light leading-[1.8] text-ink-light">
                            Tao Creative Labs is an independent venture studio focused on building, scaling, and operating next-generation SaaS businesses. We specialize in transforming cutting-edge artificial intelligence models into premium, reliable applications that people love to use. Every product in our portfolio is engineered for production, designed with care, and built to scale.
                        </p>
                    </FadeIn>
                    <FadeIn delay={0.3}>
